...
export default function AdminOfertas() {
  ...
  const cambiarDescuento = (id: number) => {
    ...
    if (isNaN(nuevoDescuento) || nuevoDescuento < 1 || nuevoDescuento > 90) {
      alert("⚠️ Ingrese un valor entre 1 y 90");
      return;
    }
  ...
  return (
    <main className="container mt-4">
      <h2 className="text-center mb-4 fw-bold text-primary">🏷️ Gestión de Ofertas</h2>
      ...
      <section className="card shadow-sm p-3 border-0">
        <h4 className="text-secondary mb-3">🛍️ Productos sin oferta</h4>
